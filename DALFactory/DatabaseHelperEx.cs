...
{
    public class DatabaseHelperEx:IDisposable
    {
        ...
        public DatabaseHelperEx(string connectionstring,Providers provider)
        {
        ...
        public DatabaseHelperEx(Providers provider):this(ConfigurationManager.ConnectionStrings["connectionstring"].ConnectionString,provider)
        {
        }

        public DatabaseHelperEx(string connectionstring): this(connectionstring, Providers.SqlServer)
        {
        }

        public DatabaseHelperEx():this(ConfigurationManager.ConnectionStrings["connectionstring"].ConnectionString,Providers.ConfigDefined)
        {
        }
